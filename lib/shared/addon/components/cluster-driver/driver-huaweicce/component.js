...
export default Component.extend(ClusterDriver, {
  ...
  zones:                       ZONES,
  clusterType:                 CLUSTTER_TYPES,
  masterVersions:              MASTER_VERSIONS,
  eipChargeModeContent:        EIP,
  containerNetworkMode:        NETWORK,
  volumeTypeContent:           VOLUME_TYPE,
  eipTypeContent:              EIP_TYPE,
  containerNetworkModeContent: CONTAINER_NETWORK,
  nodeOperationSystemContent:  NODE_OS,
  containerNetworkCidrContent: CONTAINER_CIDR,
  validityPeriodContent:       VALIDITY,
  eipShareTypeContent:         EIP_SHARE,
  vpcs:                        null,
  subnets:                     null,
  eipIds:                      null,
  nodeFlavors:                 null,
