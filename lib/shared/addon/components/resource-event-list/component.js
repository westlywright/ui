...
export default Component.extend({
  ...
  expanedDidChange: observer('expanded', 'expandAll', 'scope.currentCluster.id', function() {
    if ( ( get(this, 'expanded') || get(this, 'expandAll') ) && !isEmpty(this.scope.currentCluster)) {
